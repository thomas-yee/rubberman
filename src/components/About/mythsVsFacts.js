      ...
      <section>
        ...
        <div className="container-fluid ">
          ...
          <Row>
            <Col className="col-md-4 text-center">
              <Row className="ml-2 mr-2 pt-3 mythBackground">
                ...
                <Image
                  ...
                  fluid
                ></Image>
                <h4 className="centerHorizon pt-4">
            ...
            <Col className="col-md-4 text-center">
              <Row className="mythTitle mythBackground">
                <h4 className="centerHorizon">{content.myths.myth2.title}</h4>
                <h4 className="centerHorizon">
            ...
            <Col className="col-md-4 text-center ">
              <Row className="mythTitle ml-2 mr-2 mythBackground">
                <h4 className="centerHorizon">{content.myths.myth3.title}</h4>
                <h4 className="centerHorizon">
